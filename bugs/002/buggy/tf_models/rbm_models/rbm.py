...
class RBM(object):
    ...
    def __init__(self, num_visible, num_hidden, visible_unit_type='bin', main_dir='rbm', model_name='rbm',
        ...
        self.counter = 1 # Added By @Mehdi
        open(file="buggy/result.json", mode="w") #Added By @Mehdi
    ...
    def _run_validation_error_and_summaries(self, epoch, validation_set):
        ...
        if self.verbose == 1:
            ...
            # ///////// Added By @Mehdi
            file = open(file="buggy/result.json", mode="r+")  # Added By @Mehdi
